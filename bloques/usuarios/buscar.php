...
<div class="consulta">
    <table class="tconsulta">
        ...
        $con_user = "select * from usuario where nombre LIKE '%$datos%' or user LIKE '%$datos%' or identificacion LIKE '%$datos%' or celular LIKE '%$datos%' or direccion LIKE '%$datos%' or email LIKE '%$datos%' or rol LIKE '%$datos%' or activo LIKE '%$datos%'";
