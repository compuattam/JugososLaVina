...
<div class="consulta">
    <table class="tconsulta">
        ...
        $consulta_e = "select * from empleado where nombre LIKE '%$datos%' or identificacion LIKE '%$datos%' or direccion LIKE '%$datos%' or email LIKE '%$datos%' or celular LIKE '%$datos%' or tipo_empleado LIKE '%$datos%'";
